...
val darkCyan = Color(0xFF46CDFB)
val purple = Color(0xFF9932CC)
val yellow = Color(0xFFFDC400)

val blueAlpha20 = Color(0x20B9DAFB)
val orangeAlpha20 = Color(0x20ECACAD)
val blueAlpha = Color(0xffB9DAFB)
